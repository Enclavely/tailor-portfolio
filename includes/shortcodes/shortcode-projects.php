...
if ( ! function_exists( 'tailor_shortcode_projects' ) ) {
    ...
    function tailor_shortcode_projects( $atts, $content = null, $tag ) {
	    ...
	    $class = explode( ' ', "tailor-element tailor-projects tailor-projects--{$atts['style']} tailor-{$atts['layout']} tailor-{$atts['layout']}--projects {$atts['class']}" );
	    ...
	    if ( empty( $content ) ) {
		    $content = sprintf(
			    ...
			    __( 'Please configure this element as there is currently nothing to display', 'tailor-portfolio' )
		    );
	    }
